  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 animate-fade-in">
      ...
      <div className="card mb-8 bg-[rgba(99,102,241,0.04)] dark:bg-[rgba(129,140,248,0.06)] border-[rgba(99,102,241,0.10)] dark:border-[rgba(129,140,248,0.12)]">
        <p className="font-display font-semibold text-[#0F172A] dark:text-[#E2E8F0] mb-3 text-center">Impact Badge Tiers</p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
          ...
          ].map(b => (              <div key={b.name} className="bg-white dark:bg-[#14142D] rounded-xl p-3 border border-[rgba(99,102,241,0.08)] dark:border-[rgba(129,140,248,0.10)]">
              <p className="text-2xl mb-1">{b.emoji}</p>
              <p className="text-xs font-semibold text-[#0F172A] dark:text-[#E2E8F0] font-body">{b.name}</p>
              <p className="text-xs text-[#64748B] dark:text-[#94A3B8] font-body">{b.req}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="mt-10 text-center">
        <p className="text-[#475569] dark:text-[#94A3B8] text-sm mb-4 font-body">Want to see your name here?</p>
        <Link href="/projects" className="btn-primary">🌱 Start Donating</Link>
        <div className="mt-4">
          <Link href="/leaderboard/history" className="text-[#4F46E5] dark:text-[#818CF8] text-sm underline">
